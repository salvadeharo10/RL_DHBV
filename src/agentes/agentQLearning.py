...
class AgentQLearning(Agent):
    ...
    def get_action(self, state: int, n: int) -> int:
        ...
        - n: n+1 número de episodios transcurridos (para el decaimiento de ε si está activado).
    ...
    def update(self, state: int, action: int, reward: float, next_state: int, terminated: bool, truncated: bool) -> None:
        """
